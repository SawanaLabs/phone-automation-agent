...
class CustomerAgentContext:
    def __init__(self, *, system_prompt: str = CUSTOMER_ANDROID_SYSTEM_PROMPT) -> None:
    ...
    def record_model_output(self, *, session_id: str, output: str) -> None:
