...
| ./android-on-device-executor.md | Android On-Device Executor | Architecture boundary for moving the Customer App Story from Mac worker and ADB to an Android app with strong permissions. | 2026-06-12 |
